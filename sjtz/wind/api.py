...
data = w.edb(["S0114145","S0069669"],str(begin), end_date=str(today),Fill="Previous",usedf = True)[1]#comex黄金库存，comex黄金库存市值
...
prompt = f"""这是近一年COMEX交易所黄金库存量的数据：{data['S0114145']}
这是近一年COMEX交易所黄金库存市值的数据(单位billian)：{z}
